...
![](https://img.shields.io/github/languages/count/silvaAlex/BingoOnline)
![](https://img.shields.io/github/last-commit/silvaAlex/BingoOnline)

## Escopo do Projeto

Este projeto consiste na criação de um sistema simples do tipo "Bingo Online".
